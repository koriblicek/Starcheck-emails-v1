            ...
            en: {
                translation: {
                    ...
                    controls: {
                        ...
                        template_preview_email_addresses: 'Preview email recepients (use comma as delimiter)',
                        template_subject_line: 'Subject line',
                        template_preview_line_1: 'Preview line 1',
                        template_preview_line_2: 'Preview line 2',
                        mobile_css: 'CSS styles for mobile devices',
                        ...
                        padding_left: 'Padding from left',
                        padding_right: 'Padding from right',
                        padding_top_button: 'Button padding from top',
                        padding_bottom_button: 'Button padding from bottom',
                        padding_left_right_button: 'Button padding from sides',
                        ...
                        css_class_names_for_mobile: 'CSS class names for mobile devices',
                    ...
                    templates: {
                        ...
                        mobile_css: 'CSS styles for mobile',
                        sender_adress: 'Sender\'s address',
                        preview_email_adress: 'Preview email recepients',
                    },
                    containers: {
            ...
            sk: {
                translation: {
                    button: {
                        ...
                        editLink: 'Pridať alebo upraviť odkaz',
                    ...
                    controls: {
                        ...
                        template_preview_email_addresses: 'Adresy prijímateľov skúšobného emailu (oddelené čiarkou)',
                        template_subject_line: 'Predmet správy',
                        template_preview_line_1: 'Náhľadový riadok 1',
                        template_preview_line_2: 'Náhľadový riadok 2',
                        mobile_css: 'CSS štýly pre mobilné zariadenia',
                        ...
                        padding_left: 'Odsadenie zľava',
                        padding_right: 'Odsadenie zprava',
                        padding_top_button: 'Odsadenie textu zhora',
                        padding_bottom_button: 'Odsadenie textu zdola',
                        padding_left_right_button: 'Odsadenie textu z okrajov',
                        ...
                        css_class_names_for_mobile: 'Mená CSS tried pre mobilné zariadenia',
                    ...
                    templates: {
                        ...
                        mobile_css: 'CSS štyly pre mobil',
                        sender_adress: 'Adresa odosielateľa',
                        preview_email_adress: 'Adresy prijímateľov skúšobného emailu',
                    },
                    containers: {
